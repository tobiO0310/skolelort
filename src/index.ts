...
export const sketch = (p: p5) => {
    ...
    p.draw = function () {
        ...
        //             let vin = p.acos(item.r.x) - item.r.angleBetween(item2.r);
        //             let vin2 = p.acos(item2.r.x) - item.r.angleBetween(item2.r);
        //             (item.r.x = p.cos(vin)), (item.r.y = p.sin(vin));
        //             (item2.r.x = p.cos(vin2)), (item2.r.y = p.sin(vin2));
        //         }
        //     });
        // });
    };
